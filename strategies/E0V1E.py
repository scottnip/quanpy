...
class E0V1E(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        buy_1 = (
                ...
                (dataframe['rsi_fast'] < self.buy_rsi_fast_32.value) & # 可调参数，20-70，默认40
                (dataframe['rsi'] > self.buy_rsi_32.value) & #可调参数，15-50，默认32
    ...
    def custom_exit(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float,
        ...
        # 当前开仓价与 120 周期均线的差值比例大于等于 10% 时将交易 ID 添加到 TMP_HOLD1 列表
        ...
        if (
                trade.id in TMP_HOLD1
                # 收盘价（close）小于 120 周期移动平均线（ma120）的值
